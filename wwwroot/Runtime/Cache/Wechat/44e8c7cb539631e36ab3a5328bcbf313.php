...
<div class="main">
    ...
    <div class="container-fluid" style="margin-top: 5%;">
        ...
        <form action=" <?php echo U('repair');?>" method="post">
            ...
            <div class="controls" style="margin-bottom: 20px;">
                <img class="verifyimg reloadverify" alt="点击切换" onclick="this.src='/index.php?s=/Home/User/verify.html'" src="/index.php?s=/Home/User/verify.html" style="cursor:pointer;height: 40px;">
            </div>
            <div class="form-group">
