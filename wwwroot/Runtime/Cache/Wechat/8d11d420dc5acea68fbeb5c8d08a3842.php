...
<div class="main">
    ...
    <div class="container-fluid" id="content_list" name="1">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rr): $mod = ($i % 2 );++$i;?><div class="row noticeList">
                ...
                <div class="col-xs-10">
                    <p class="title"> <a href="<?php echo U('bao?id='.$rr['id']);?>" ><?php echo ($rr["title"]); ?></a></p>
                    <p class="intro"><a href="<?php echo U('bao?id='.$rr['id']);?>" ><?php echo ($rr["description"]); ?></a></p>
                    <p class="info">浏览: <a href="<?php echo U('bao?id='.$rr['id']);?>" ><?php echo ($rr["view"]); ?></a> <span class="pull-right"><?php echo date('Y-m-d H:i:s',$rr['create_time']);?></span> </p>
                </div>
...
<script type="application/javascript">
    ...
    var url = 'index.php?s=/Wechat/Wechat/message';
                        ...
                        $(data.data).each(function (i,v) {
                            ...
                            html = '<div class="row noticeList">\
                                       \
                                                ...
                                                <div class="col-xs-10">\
                                                    <p class="title"><a href="/wchat.php?s=/Wechat/Wechat/bao/id/' + v.id + '.html" >' + v.title + '</a></p>\
