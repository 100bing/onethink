        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wechat): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <?php echo ($wechat["content"]); ?>
                                <div class="caption">
                                    <h4> <?php echo ($wechat["title"]); ?></h4>

                                    <p class="text-danger"><?php echo ($wechat["price"]); echo $wechat['unit']==1?'元/月':'万元/月';?></p>
                                    <p><a href="<?php echo U('detail?id='.$wechat['id']);?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    <div class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            <?php if(is_array($index)): $i = 0; $__LIST__ = $index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$we): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-4">
                                <div class="thumbnail">
                                    <?php echo ($we["content"]); ?>
                                    <div class="caption">
                                        <h4> <?php echo ($we["title"]); ?></h4>

                                        <p class="text-danger"><?php echo ($we["price"]); echo $we['unit']==1?'元/月':'万元/月';?></p>
                                        <p><a href="<?php echo U('detail?id='.$wechat['id']);?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                    </div>
                                </div>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
