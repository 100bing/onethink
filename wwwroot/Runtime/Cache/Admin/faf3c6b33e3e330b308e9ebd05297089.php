...
<body>
    ...
    <form  method="post" class="form-horizontal">
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                ...
                <select style="width: 200px;" name="unit">
                    <option value="1"<?php if(($unit) == "{info.unit}"): ?>selected<?php endif; ?>>元/月</option>
                    <option value="2"<?php if(($unit) == "{info.unit}"): ?>selected<?php endif; ?>>万元</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="neixing">
                    <option value="1" <?php if(($neixing) == "info.neixing"): ?>selected<?php endif; ?>>出租</option>
                    <option value="0" <?php if(($neixing) == "info.neixing"): ?>selected<?php endif; ?>>出售</option>
                </select>
            </div>
        </div>
